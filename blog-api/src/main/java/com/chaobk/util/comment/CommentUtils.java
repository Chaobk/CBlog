package com.chaobk.util.comment;

import com.chaobk.config.properties.BlogProperties;
import com.chaobk.enums.CommentOpenStateEnum;
import com.chaobk.enums.CommentPageEnum;
import com.chaobk.model.dto.Comment;
import com.chaobk.model.vo.FriendInfo;
import com.chaobk.util.comment.channel.ChannelFactory;
import com.chaobk.util.comment.channel.CommentNotifyChannel;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import com.chaobk.constant.PageConstants;
...
import com.chaobk.util.QQInfoUtils;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.chaobk.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.chaobk.entity.Comment parentComment, Comment comment) {
