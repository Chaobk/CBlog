package com.chaobk.util.quartz;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.chaobk.entity.ScheduleJob scheduleJob = (com.chaobk.entity.ScheduleJob) context.getMergedJobDataMap().get(com.chaobk.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
